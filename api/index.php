...
try {
    switch ($action) {
        ...
        case 'attendance-summary':
            handleAttendanceSummary($request);
            break;
        ...
        case 'compliance-calendar':
            handleComplianceCalendar($request);
            break;
        ...
        case 'minimum-wages':
            handleMinimumWages($method, $request);
            break;
...
function handleAttendanceSummary($request) {
    global $auth, $useApiKey;
...
function handlePayroll($method, $request) {
    global $auth, $useApiKey;
...
// Compliance Handlers
function handleComplianceCalendar($request) {
    global $auth, $useApiKey;
...
function handleMinimumWages($method, $request) {
    global $auth, $useApiKey;
