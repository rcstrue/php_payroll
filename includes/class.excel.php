    ...
    public function generateTemplate($type) {
        $templates = [
            'attendance' => [
                ...
                ['EMP001', 'Ramesh Kumar', '01-01-2025', 'P', '09:00', '18:00', '1'],
                ['EMP001', 'Ramesh Kumar', '02-01-2025', 'P', '09:00', '18:00', '0']
            ],
            'employees' => [
                ...
                ['EMP001', 'Ramesh', 'Kumar', 'male', '01-01-1990', '9876543210', '123456789012', 'ABCDE1234F', 'SBI', '12345678901', 'SBIN0001234', 'Security Guard', 'skilled', 'worker', '01-01-2025', '12000', '1500', '3000', 'Gujarat', 'yes', 'yes']
            ],
            'pf_active' => [
                ['uan', 'member_name', 'gender', 'dob', 'father_name', 'date_of_joining', 'gross_salary'],
                ['123456789012', 'Ramesh Kumar', 'M', '01-01-1990', 'Shri Ram', '01-01-2025', '16500']
            ]
        ];
