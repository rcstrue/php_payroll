                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="designation" class="form-control" 
                                   value="<?php echo $deployment['designation']; ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Department</label>
                            <input type="text" name="department" class="form-control" 
                                   value="<?php echo $deployment['department']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Reporting To</label>
                            <input type="text" name="reporting_to" class="form-control" 
                                   value="<?php echo $deployment['reporting_to']; ?>" placeholder="Supervisor name">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" name="deployment_date" class="form-control" 
                                   value="<?php echo $deployment['deployment_date']; ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Expected End Date</label>
                            <input type="date" name="end_date" class="form-control" 
                                   value="<?php echo $deployment['end_date']; ?>">
                        </div>
                        <div class="col-md-6">
