                    ...
                    <table class="table table-hover mb-0" id="clientsTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo sanitize($c['contact_email'] ?? '-'); ?></td>
                                ...
                                <td>
                                    <span class="badge bg-<?php echo $c['is_active'] ? 'success' : 'danger'; ?>">
...
function editClient(client) {
    ...
    $('#edit_email').val(client.contact_email || '');
    $('#edit_phone').val(client.contact_phone || '');
