                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="full_name" class="form-control" 
                                   value="<?php echo $applicant['full_name']; ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Father's Name</label>
                            <input type="text" name="father_name" class="form-control" 
                                   value="<?php echo $applicant['father_name']; ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Date of Birth</label>
                            <input type="date" name="date_of_birth" class="form-control" 
                                   value="<?php echo $applicant['date_of_birth']; ?>">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="tel" name="mobile_number" class="form-control" 
                                   value="<?php echo $applicant['mobile_number']; ?>" required maxlength="10">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="address" class="form-control" rows="2"><?php echo $applicant['address']; ?></textarea>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="state" class="form-control" 
                                   value="<?php echo $applicant['state']; ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Pincode</label>
                            <input type="text" name="pincode" class="form-control" 
                                   value="<?php echo $applicant['pincode']; ?>" maxlength="6">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="aadhaar_number" class="form-control" 
                                   value="<?php echo $applicant['aadhaar_number']; ?>" maxlength="12">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">PAN Number</label>
                            <input type="text" name="pan_number" class="form-control" 
                                   value="<?php echo $applicant['pan_number']; ?>" maxlength="10">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="qualification" class="form-control" 
                                   value="<?php echo $applicant['qualification']; ?>" placeholder="e.g., 10th Pass, ITI, Graduate">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="current_employer" class="form-control" 
                                   value="<?php echo $applicant['current_employer']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Preferred Location</label>
                            <input type="text" name="preferred_location" class="form-control" 
                                   value="<?php echo $applicant['preferred_location']; ?>">
                        </div>
                        <div class="col-md-6">
