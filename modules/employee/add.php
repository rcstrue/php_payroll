...
// Get designations with visibility status
$designations = [];
try {
    $stmt = $db->query("SELECT id, name, desi_view FROM designations ORDER BY name");
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="gender" name="gender">
                                ...
                                <option value="male" <?php echo strtolower($employeeData['gender'] ?? '') === 'male' ? 'selected' : ''; ?>>Male</option>
                                <option value="female" <?php echo strtolower($employeeData['gender'] ?? '') === 'female' ? 'selected' : ''; ?>>Female</option>
                                <option value="other" <?php echo strtolower($employeeData['gender'] ?? '') === 'other' ? 'selected' : ''; ?>>Other</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="marital_status" name="marital_status">
                                <option value="">Select</option>
                                <option value="single" <?php echo strtolower($employeeData['marital_status'] ?? '') === 'single' ? 'selected' : ''; ?>>Single</option>
                                <option value="married" <?php echo strtolower($employeeData['marital_status'] ?? '') === 'married' ? 'selected' : ''; ?>>Married</option>
                                <option value="divorced" <?php echo strtolower($employeeData['marital_status'] ?? '') === 'divorced' ? 'selected' : ''; ?>>Divorced</option>
                                <option value="widowed" <?php echo strtolower($employeeData['marital_status'] ?? '') === 'widowed' ? 'selected' : ''; ?>>Widowed</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" name="designation">
                                ...
                                <?php foreach ($designations as $des): 
                                    $selected = ($employeeData['designation'] ?? '') === $des['name'] ? 'selected' : '';
                                    $visibility = $des['desi_view'] ? '✓' : '✗';
                                    $badge = $des['desi_view'] ? 'text-success' : 'text-muted';
                                ?>
                                <option value="<?php echo sanitize($des['name']); ?>" <?php echo $selected; ?>>
                                    <?php echo sanitize($des['name']); ?> <span class="<?php echo $badge; ?>">(<?php echo $des['desi_view'] ? 'Show' : 'Hide'; ?>)</span>
                                </option>
                                <?php endforeach; ?>
                            </select>
                            <small class="text-muted">✓ = Portal Visible, ✗ = Hidden</small>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" name="worker_category">
                                <option value="unskilled" <?php echo strtolower($employeeData['worker_category'] ?? '') === 'unskilled' ? 'selected' : ''; ?>>Unskilled</option>
                                <option value="semi-skilled" <?php echo strtolower($employeeData['worker_category'] ?? '') === 'semi-skilled' ? 'selected' : ''; ?>>Semi-Skilled</option>
                                <option value="skilled" <?php echo strtolower($employeeData['worker_category'] ?? '') === 'skilled' ? 'selected' : ''; ?>>Skilled</option>
                                <option value="supervisor" <?php echo strtolower($employeeData['worker_category'] ?? '') === 'supervisor' ? 'selected' : ''; ?>>Supervisor</option>
                                <option value="manager" <?php echo strtolower($employeeData['worker_category'] ?? '') === 'manager' ? 'selected' : ''; ?>>Manager</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Employment Type</label>
                            <select class="form-select" name="employment_type">
                                <option value="contract" <?php echo strtolower($employeeData['employment_type'] ?? '') === 'contract' ? 'selected' : ''; ?>>Contract</option>
                                <option value="permanent" <?php echo strtolower($employeeData['employment_type'] ?? '') === 'permanent' ? 'selected' : ''; ?>>Permanent</option>
                                <option value="temporary" <?php echo strtolower($employeeData['employment_type'] ?? '') === 'temporary' ? 'selected' : ''; ?>>Temporary</option>
                                <option value="daily-wages" <?php echo strtolower($employeeData['employment_type'] ?? '') === 'daily-wages' ? 'selected' : ''; ?>>Daily Wages</option>
                            </select>
                        </div>
                        <div class="col-md-3">
