...
$filters = [
    ...
    'worker_category' => $_GET['worker_category'] ?? null,
                    ...
                    <table class="table table-hover mb-0" id="employees-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div><small class="text-muted">Client:</small> <?php echo sanitize($emp['client_name'] ?? '-'); ?></div>
                                    <div><small class="text-muted">Unit:</small> <?php echo sanitize($emp['unit_name'] ?? '-'); ?></div>
                                </td>
