                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="designation" class="form-control" 
                                   value="<?php echo $requisition['designation']; ?>" 
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="required_by_date" class="form-control" 
                                   value="<?php echo $requisition['required_by_date']; ?>" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="requested_by" class="form-control" 
                                   value="<?php echo $requisition['requested_by']; ?>" placeholder="Client contact person">
                        </div>
                        <div class="col-12">
                            <label class="form-label">Special Requirements</label>
                            <textarea name="special_requirements" class="form-control" rows="2" 
                                      placeholder="Any specific requirements like height, languages known, certifications, etc."><?php echo $requisition['special_requirements']; ?></textarea>
                        </div>
                        <div class="col-12">
                            <label class="form-label">Notes</label>
                            <textarea name="notes" class="form-control" rows="2"><?php echo $requisition['notes']; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
