...
// Pagination
if (!defined('RECORDS_PER_PAGE')) define('RECORDS_PER_PAGE', DEFAULT_PAGE_SIZE);

// Date Formats
if (!defined('DATE_FORMAT')) define('DATE_FORMAT', DATE_FORMAT_DISPLAY);
if (!defined('DATETIME_FORMAT')) define('DATETIME_FORMAT', DATETIME_FORMAT_DISPLAY);

// File Upload Settings
if (!defined('MAX_FILE_SIZE')) define('MAX_FILE_SIZE', MAX_FILE_SIZE_UPLOAD);
